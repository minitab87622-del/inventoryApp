...
class ImportsScreen(BoxLayout):
    ...
    def __init__(self, app, **kwargs):
        ...
        title = Label(
            text=ar("إدخال الكمية المستوردة"),
            font_name="Arabic",
            size_hint_y=None,
            height=50,
            halign="right",
        ...
        save_btn.bind(on_press=self.save_import)
    ...
    def save_import(self, btn):
        ...
        for name, box in self.boxes.items():
            ...
            if amount > 0:
                if self.app.db.add_import(name, amount):
                    any_saved = True
